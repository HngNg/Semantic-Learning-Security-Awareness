...
plt.plot(snr, train_acc, label='Bob - Accuracy over SNR', marker='o', color = colors[color_cnt])
color_cnt+=1
...
plt.plot(snr, train_acc, label='Eve - Accuracy over SNR', marker='o', color = colors[color_cnt])
color_cnt+=1
